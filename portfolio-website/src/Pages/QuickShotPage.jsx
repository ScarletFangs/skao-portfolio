  ...
  return (
    <div className="HeadHunted-Container">
        ...
        <div className="HeadHunted-InfoBar">
            ...
            <div className="HeadHunted-InfoBar-MiniGroup">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4CE6A6" viewBox="0 0 256 256" aria-label="Timer Icon">
            ...
            <hr className="HeadHunted-InfoBar-Divider"/>
            <div className="HeadHunted-InfoBar-MiniGroup">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4CE6A6" viewBox="0 0 256 256" aria-label="Game Icon">
        ...
        <img src={QSPhoto1} alt="QuickShot Splash Art"/>
        ...
        <div className="HeadHunted-QuickInfo-Container">
            <div className="HeadHunted-QuickInfo-Description">
                <div className="HeadHunted-QuickInfo-Label">
                    ...
                    <p><strong className="Description-Label">Tools</strong>: GitHub, Photoshop, CodeDecks, Figma</p>
                    <p><strong className="Description-Label">Roles</strong>: Programmer</p>
                    <p><strong className="Description-Label">Duration</strong>: March 2024 - June 2024</p>
                    <p><strong className="Description-Label">Game</strong>: Fast pace online multiplayer FPS death match game, where you use a sniper to dominate the competition.</p>
                    <p><strong className="Description-Label">Team Size</strong>: 14 Students</p>
                </div>
                <p>
            ...
            <img src={QSPhoto2} alt="QuickShot Map Overview"/>
        </div>
